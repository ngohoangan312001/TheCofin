      ...
      <div class="row">
          ...
          <form action="{{route('postthemadmin')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="ademail" placeholder="Vui lòng nhập email đăng nhập" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="adname" placeholder="Vui lòng nhập họ và tên" />
                    </div>
                    <div class="form-group">
