    ...
    public function postComment(Request $rs){
        if(Session::has('logined')){
            $this->validate(
                $rs,
                [
                    'cment_titile' => 'bail|max:70',
                    'cment_content' => 'bail|required|max:500'
                ],
                [
                    'cment_title.max' => 'Tiêu đề bình luận không được dài quá 70 ký tự',
                    'cment_content.required' => 'Nội dung bình luận không được để trống',
                    'cment_content.max' => 'Nội dung bình luận không được dài quá 500 ký tự',
                ]
                );
